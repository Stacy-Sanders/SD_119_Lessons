    ...
    public class LoopExamples
    {
        ...
        public void WhileLoops ()
        {
            ...
            while (keepLooping)
            {
                ...
                {
                    continue;               // Continue means skip all the code that comes after
                }
        ...
        public void ForLoops()
        {
            ...
            // 2 - Loop Condition - keeps looping while this == true
            // 3 - Iterative action - happens at the end of every loop
            // 4 - The Loops - the code that is repeated
            //    1             2               3             
            ...
            string[] students = { "Jonah", "Andrew L", "Andrew S", "Brandon", "Doug" }; // This is an array
            ...
            foreach (char letter in "Stacy Sanders")
            {
